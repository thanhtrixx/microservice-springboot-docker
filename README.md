...
5. The customer can check all the voucher codes that they have purchased by phone number on the website, but it needs to be secured. {#Problem5}
...
7. From (Problem #5)(#Problem5) &#8594; must use database
